...
import { CreatePostFormInput } from '../types/form.type'

export type Props = {
  defaultValues?: CreatePostFormInput
  onSubmitClick(data: CreatePostFormInput, reset: UseFormReset<CreatePostFormInput>): void
  openDialog: boolean
...
const CreatePostDialogForm = (props: Props) => {
  ...
  const methods = useForm<CreatePostFormInput>({
    defaultValues,
  ...
  const submitHandler = (data: CreatePostFormInput) => {
