    ...
    <Container maxWidth="lg">
      ...
      <Paper elevation={3} sx={{ textAlign: "center" }}>
        <Grid container spacing={0}>
          <Grid item xs={6} sx={{}}>
            <Typography sx={{ fontWeight: "bold", marginBottom: "20px", marginTop: "20px", fontSize: "25px", color: MainColor.RED_450 }}>Đăng ký </Typography>
          ...
          <Grid item xs={6}>
            <Image
              src={
                'https://cara.edu.vn/wp-content/uploads/2021/03/o1.jpg'
              }
